...
export const BehanceIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M6.938 4.5c1.196 0 2.193.308 2.99 0.924 0.798 0.616 1.197 1.488 1.197 2.616 0 0.741-0.187 1.385-0.562 1.932-0.375 0.547-0.902 0.963-1.582 1.25 0.914 0.281 1.605 0.768 2.074 1.461 0.469 0.693 0.703 1.516 0.703 2.47 0 1.266-0.434 2.273-1.301 3.023-0.867 0.75-2.004 1.125-3.41 1.125h-6.047v-14.801h5.942zm-2.734 5.754h2.52c0.672 0 1.207-0.141 1.605-0.422 0.398-0.281 0.598-0.703 0.598-1.266 0-0.562-0.199-0.984-0.598-1.266-0.398-0.281-0.934-0.422-1.605-0.422h-2.52v3.376zm0 5.672h2.648c0.75 0 1.348-0.164 1.793-0.492 0.445-0.328 0.668-0.812 0.668-1.453 0-0.641-0.223-1.125-0.668-1.453-0.445-0.328-1.043-0.492-1.793-0.492h-2.648v3.89zm13.125-3.035c0.07 1.055 0.422 1.863 1.055 2.426 0.633 0.562 1.465 0.844 2.496 0.844 0.938 0 1.734-0.199 2.391-0.598 0.656-0.398 1.09-0.902 1.301-1.512h2.953c-0.375 1.547-1.184 2.766-2.426 3.656-1.242 0.891-2.766 1.336-4.57 1.336-1.898 0-3.469-0.586-4.711-1.758-1.242-1.172-1.863-2.777-1.863-4.816 0-1.992 0.609-3.594 1.828-4.805 1.219-1.211 2.777-1.816 4.676-1.816 1.945 0 3.516 0.598 4.711 1.793 1.195 1.195 1.793 2.777 1.793 4.746v0.902h-10.633zm7.641-2.074c-0.094-0.844-0.422-1.488-0.984-1.934-0.562-0.445-1.289-0.668-2.18-0.668-0.867 0-1.57 0.223-2.109 0.668-0.539 0.445-0.891 1.09-1.055 1.934h6.328zm-7.617-6.527h5.906v1.734h-5.906v-1.734z" />
  </svg>
);
...
export { Social3DOrbit } from './Social3DOrbit';
